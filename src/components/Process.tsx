  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl p-8 border border-blue-200">
        <h3 className="text-xl font-bold text-slate-900 mb-4">Timeline & Support</h3>
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h4 className="font-semibold text-blue-600 mb-2">Scope Analysis</h4>
          ...
          <div>
            <h4 className="font-semibold text-blue-600 mb-2">Ongoing Support</h4>
            <p className="text-slate-600">
